...
import { GENERAL_INFO, LINKEDIN_PROFILE_URL, SOCIAL_LINKS } from '@/lib/data';
...
const MENU_LINKS = [
    { name: 'Início', url: '/#banner' },
    { name: 'Sobre', url: '/#about-me' },
    { name: 'Experiência', url: '/#my-experience' },
    { name: 'Projetos', url: '/#selected-projects' },
];
        ...
        <>
            ...
            >
                ...
                <div className="w-full max-w-[300px] mx-8 sm:mx-auto">
                    <p className="text-muted-foreground mb-4">CONTATO</p>
